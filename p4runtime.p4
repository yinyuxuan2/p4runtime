...
def main(p4info_file_path, bmv2_file_path):
    ...
    try:
        ...
        while True:
            ...
            print('----- s1 -> s3 -----')
            printCounter(p4info_helper, s1, "NyIngress.ingressTunnelCounter", 200)
            ...
            printCounter(p4info_helper, s1, "NyIngress.egressTunnelCounter", 201)
            print('----- s2 -> s3 -----')
